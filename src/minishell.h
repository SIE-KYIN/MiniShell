...
** +2
*/
t_tree			*tokenize(char *line, t_list *env_list, t_info *info);
...
char			**heredoc_processing(char **str, t_info *info);
char			**return_condition(int flag, char **ret, char **tmp);
/*
** utils3.c
** related to ft_ms_split.c
*/
